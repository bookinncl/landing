  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative w-full min-h-[70vh] md:min-h-[80vh] overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 pt-16 pb-10 md:py-24">
          <div className="grid md:grid-cols-2 gap-8 md:gap-10 items-center">
            {/* Texto */}
            <motion.div initial={{ opacity: 0, y: 6 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.45 }}>
              <span className="inline-block mb-3 md:mb-4 rounded bg-white/10 text-white border border-white/20 text-[11px] md:text-xs px-2 py-1">
              ...
              <p className="mt-3 md:mt-4 text-white/90 text-base md:text-lg leading-relaxed max-w-[42ch]">
              ...
              <div className="mt-5 md:mt-6 flex flex-wrap gap-3">
                <a href="#contacto" className="px-4 py-2.5 md:py-3 rounded bg-white text-slate-900 text-sm">Solicitar demo</a>
                <a href="#features" className="px-4 py-2.5 md:py-3 rounded border border-white/60 text-white text-sm bg-white/10 hover:bg-white/20">
                  Ver cómo funciona
                </a>
              </div>

              <p className="mt-4 text-xs md:text-sm text-white/90 flex items-center gap-4">
            ...
            >
              <div className="mt-8 md:mt-0 rounded-2xl border border-white/40 shadow-xl p-5 md:p-6 bg-white/95 backdrop-blur max-w-md w-full">
                ...
                <button className="mt-4 w-full px-4 py-2.5 rounded bg-slate-900 text-white text-sm">Consultar</button>
